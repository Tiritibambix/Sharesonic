...
* Frosted-glass effects: navigation drawer, track-info dialog, playlist picker and long-press context menu all blur the content behind them (`Modifier.blur`, API 31+) with a dark scrim + `Surface` card (rounded 20 dp, primary-tinted border)
